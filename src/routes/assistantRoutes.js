...
router.get(
    ...
    [
        ...
        query("sortBy").optional().isIn(['popular', 'newest', 'mostUsed', 'mostLiked', 'mostViewed', 'verified']).withMessage("Invalid sort option."),
        ...
        query("favoritesOnly").optional().isIn(['true', 'false']).withMessage("favoritesOnly must be true or false."),
