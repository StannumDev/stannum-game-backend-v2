...
router.post("/:programId/sections/:sectionId/resources",
    [validateAPIKey, programIdParam, sectionIdParam, check("title").trim().notEmpty(), check("type").trim().notEmpty().isIn(["document", "video", "presentation", "folder", "activity", "submission"]).withMessage("Tipo de recurso inválido"), fieldsValidate],
...
router.post("/:programId/sections/:sectionId/modules/:moduleId/instructions/:instructionId/resources",
    [validateAPIKey, programIdParam, sectionIdParam, moduleIdParam, instructionIdParam, check("title").trim().notEmpty(), check("type").trim().notEmpty().isIn(["document", "video", "presentation", "folder", "activity", "submission"]).withMessage("Tipo de recurso inválido"), fieldsValidate],
