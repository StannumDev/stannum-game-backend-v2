...
router.post(
  ...
  [
    validateMakeAPIKey,
    check("email", "El email es obligatorio y debe ser válido.").trim().escape().notEmpty().withMessage("El email no puede estar vacío.").isEmail().withMessage("El formato del email es inválido.").normalizeEmail(),
    ...
    check("product", "El producto debe ser un string válido.").optional().trim().escape().isIn(["tia"]).withMessage("El producto debe ser: tia, stannum_pro o bootcamp."),
