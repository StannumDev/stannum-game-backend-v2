...
router.post(
  ...
  [
    ...
    check("aboutme", "About me is required.").trim().escape().not().isEmpty().withMessage("About me cannot be empty.").isLength({ max: 500 }).withMessage("About me must be less than 500 characters."),
    fieldsValidate,
  ],
