...
// ── GET / ── Lista de programas (summary)
...
const updateProgram = async (req, res) => {
    try {
        ...
        const allowedFields = ["name", "price", "href", "categories", "description"];
        const updates = {};
...
// WARNING: arrayFilters silently no-ops if sectionId doesn't match any nested element.
// The update will return the program doc without error even if no section was actually updated.
...
// WARNING: arrayFilters silently no-ops if sectionId or moduleId doesn't match any nested element.
// The update will return the program doc without error even if no module was actually updated.
...
// WARNING: arrayFilters silently no-ops if sectionId, moduleId, or lessonId doesn't match any nested element.
// The update will return the program doc without error even if no lesson was actually updated.
...
// WARNING: arrayFilters silently no-ops if sectionId, moduleId, or instructionId doesn't match any nested element.
// The update will return the program doc without error even if no instruction was actually updated.
...
// WARNING: arrayFilters silently no-ops if sectionId or resourceId doesn't match any nested element.
// The update will return the program doc without error even if no resource was actually updated.
...
// WARNING: arrayFilters silently no-ops if sectionId, moduleId, instructionId, or resourceId doesn't match any nested element.
// The update will return the program doc without error even if no resource was actually updated.
